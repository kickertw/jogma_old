<?php
    //This file is to be included by gradlist_students_search.php
?>
...
<?php
                    for($idx=0; $idx <= count($rankListName); $idx++){
                        if($rankListSequence[$idx] > $row['sequence'] && strlen(trim($rankListName[$idx])) > 0){
?>
...
?>
    ...
    <tr><td>
        <input name="addToListButton" type="submit" value="Add Students">
        <input name="addToListButton2" type="submit" value="Add and Save">
        <input name="gotoNextStep" type="submit" value="Cancel">        
    </td></tr>
    </table>
<?php
    }
